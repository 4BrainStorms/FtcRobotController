...
/**
 * RED alliance auton using Limelight + Road Runner.
 * Starts in Square D with right wheels on line Y.
 */
@Autonomous(name="Auton: RED (LL+RR)", group="AA Auton")
public class RedAllianceAutonRR extends LimelightAutonBaseRR {

    @Override protected boolean isBlueAlliance() { return false; }
